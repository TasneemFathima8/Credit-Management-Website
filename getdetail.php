...
<html>
 <head>
   ...
   viewUser
    ...
    <body>
        <h1 style=" font-family:Agency FB; font-size: 50px ;text-align: center; margin: 50px "><u> User Information </u></h1>
...
<br><br><br><br><br>
         <a href="index.php"><input type="button" name=" HOME " value=" HOME "  style="width=500px; height=250px; position:absolute;
